...
export interface Transporter {
    sendMail: (mailOptions: MailOptions) => Promise<{ messageId: string | null | undefined }>;
}
...
const createTransporter = async (): Promise<Transporter> => {
    try {
        ...
        console.error('✗ Transporter creation failed:', error instanceof Error ? error.message : String(error));
        throw error;
    }
};
