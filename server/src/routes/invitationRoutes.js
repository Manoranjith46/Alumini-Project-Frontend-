...
import { createInvitation, getAllInvitations, getDepartmentInvitations, getInvitationById, getFlyerImage } from '../controllers/invitationController.js';
...
// Coordinator/Admin gets department invitations
router.get('/department/all', authenticate, getDepartmentInvitations);
