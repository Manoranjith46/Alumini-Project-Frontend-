...
interface AdminAluminiFormProps {
  onLogout?: () => void;
}

const Admin_Alumini_Form = ({ onLogout }: AdminAluminiFormProps) => {
  const { user } = useAuth();
  ...
  const onSignatureCropComplete = (croppedArea: any, croppedAreaPixels: any) => {
